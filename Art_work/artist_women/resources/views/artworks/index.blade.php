...
@section('content')
    ...
    <h3 class="text-center">ARTWORK MANAGEMENT</h3>
        <div>
            @if (session('success'))
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" scope="col">Art Type</th>
                        <th class="text-center" scope="col">Media Link</th> 
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#artwork{{ $artwork->id }}"><i class="fa-solid fa-trash"></i>
                                </button>
